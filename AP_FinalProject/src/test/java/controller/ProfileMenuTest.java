...
class ProfileMenuTest {
    ...
    @Test
    void emptyChangePassword(){
        createUser("ahmad", "ali@gmail.com");
        Matcher matcher = Commands.getOutput("Profile  change   password -n \"\" -o \"\"", Commands.CHANGE_PASSWORD);
        assertEquals("The required field is empty, changing password failed", MainController.changePasswordPart1(matcher));
