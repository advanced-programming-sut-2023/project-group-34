...
public class MainController {
    ...
    private static String checkBlockType (Block block, BuildingType buildingType) {
        ...
        ArrayList<BlockType> goodBlockTypes = new ArrayList<>(Arrays.asList(BlockType.GROUND, BlockType.STONY_GROUND, BlockType.GRASS, BlockType.MEADOW, BlockType.DENSE_MEADOW, BlockType.BEACH, BlockType.PLAIN));
